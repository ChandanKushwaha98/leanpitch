...
const Videos = ({border = 'none',bgColor = 'white'}) => {
        ...
        <Box style={{
            ...
            <Box style={{ display: 'flex', alignItems: 'space-between', justifyContent: 'space-between', }}>
                <Box style={{ marginRight: '2vw' }}>
                    <ReactPlayer controls autoPlay='autoPlay' width='240px' height='120px' className={classes.media} url='https://www.youtube.com/watch?v=7sDY4m8KNLc' />
                </Box>
                <Box style={{ marginRight: '2vw' }} >
